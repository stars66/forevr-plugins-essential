...
namespace Vuplex.WebView {
    ...
    struct GeckoTextureCreatorInvocation {
        public int id;
    ...
    public class AndroidGeckoTextureCreator : MonoBehaviour {
        ...
        public static AndroidGeckoTextureCreator Instance {
            get {
                if (!_instance) {
                    _instance = (AndroidGeckoTextureCreator) new GameObject("AndroidGeckoTextureCreator").AddComponent<AndroidGeckoTextureCreator>();
        ...
        public void CreateTexture(float width, float height, Action<Texture2D> callback) {
            ...
            var error = Utils.GetGraphicsApiErrorMessage(SystemInfo.graphicsDeviceType, new GraphicsDeviceType[] { GraphicsDeviceType.OpenGLES3, GraphicsDeviceType.OpenGLES2 });
            if (error != null) {
            ...
            var invocation = new GeckoTextureCreatorInvocation {
        ...
        static AndroidGeckoTextureCreator _instance;
        List<GeckoTextureCreatorInvocation> _pendingInvocations = new List<GeckoTextureCreatorInvocation>();
