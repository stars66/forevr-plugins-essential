...
namespace Vuplex.WebView {
    ...
    class AndroidGeckoByteArrayCallback : AndroidJavaProxy {

        public AndroidGeckoByteArrayCallback(Action<byte[]> callback) : base("com.vuplex.webview.gecko.ByteArrayCallback") {
            _callback = callback;
        }
        ...
        public void callback(AndroidJavaObject result) {
            ...
            var bytes = Utils.ConvertAndroidByteArray(byteArrayObject);
